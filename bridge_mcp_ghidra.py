...
def search_functions_by_name(query: str, offset: int = 0, limit: int = 100) -> list:
    ...
    """
    # Convert to string to handle direct Python calls with integers
    # When called via MCP, Pydantic accepts only strings, preventing "5e20" from being parsed as float
