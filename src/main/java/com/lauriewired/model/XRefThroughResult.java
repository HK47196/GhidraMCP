 ...
 * Contains all dereferences found and metadata about the analysis.
 */
public class XRefThroughResult {
    ...
    public static class Builder {
        ...
        public XRefThroughResult build() {
            if (success && analysisStats == null) {
                throw new IllegalStateException("analysisStats required for successful result");
            }
